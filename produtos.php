...
<div class= "container-fluid">
  <div class="container-fluid">
    ...
    <table class="table table-dark table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="produtos/editar.php?id=<?php echo $dados['id']; ?>" class="btn btn-warning"><i class="material-icons">edit</i></a></td>
    ...
    <br>
    <a href="produtos/adicionar.php" class="btn btn-primary"> Adicionar produto </a>
